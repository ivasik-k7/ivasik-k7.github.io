...
export const LINE = [
  { id: "gdansk", name: "GDANSK GL.", scene: null },
  { id: "stocznia", name: "STOCZNIA", scene: null },
  { id: "politechnika", name: "POLITECHNIKA", scene: null },
  { id: "oliwa", name: "OLIWA", scene: "district" as string | null },
  { id: "przymorze", name: "PRZYMORZE-UNIW.", scene: "station" as string | null },
  { id: "zaspa", name: "ZASPA", scene: null },
  { id: "sopot", name: "SOPOT", scene: null },
  { id: "gdynia", name: "GDYNIA GL.", scene: null },
] as const;
